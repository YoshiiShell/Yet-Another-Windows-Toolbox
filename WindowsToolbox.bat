...
echo Allowing WS and Xbox to be updated
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.WindowsStore_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.StorePurchaseApp_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.XboxApp_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.Xbox.TCUI_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.XboxGamingOverlay_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.XboxGameOverlay_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.XboxIdentityProvider_8wekyb3d8bbwe" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\Microsoft.XboxSpeechToTextOverlay_8wekyb3d8bbwe" /f
echo Reinstallng Xbox packages
powershell -Command "Add-AppxPackage -RegisterByFamilyName -MainPackage 'Microsoft.Xbox.TCUI_8wekyb3d8bbwe'"
powershell -Command "Add-AppxPackage -RegisterByFamilyName -MainPackage 'Microsoft.XboxGamingOverlay_8wekyb3d8bbwe'"
powershell -Command "Add-AppxPackage -RegisterByFamilyName -MainPackage 'Microsoft.XboxGameOverlay_8wekyb3d8bbwe'"
powershell -Command "Add-AppxPackage -RegisterByFamilyName -MainPackage 'Microsoft.XboxGameUI_8wekyb3d8bbwe'"
...
echo Windows Error reporting packages
...
echo Windows Application Experience
...
echo Media Foundation Aggregator
...
ehco "Security-PwdlessPlat-Aggregator"
...
echo System Settings SIUF handlers
...
echo Intel Indeo Codecs
powershell -ExecutionPolicy Unrestricted "Get-WindowsPackage -Online -PackageName '* Microsoft-Windows-Indeo4-Codecs*' | Remove-WindowsPackage -Online"
powershell -ExecutionPolicy Unrestricted "Get-WindowsPackage -Online -PackageName '* Microsoft-Windows-Indeo5-Codecs*' | Remove-WindowsPackage -Online"
